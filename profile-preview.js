(() => {
  ...
  const copy = {
    ...
    'en-SG': { open:'Open profile', close:'Close profile', online:'Online now', about:'About me', voice:'Voice message', play:'Play', pause:'Pause', last:'Latest message', message:'I don’t think I’ve told you the most important thing yet…', cta:'Open conversation', label:'Maria’s profile' },
    de: { open:'Profil öffnen', close:'Profil schließen', online:'Jetzt online', about:'Über mich', voice:'Sprachnachricht', play:'Abspielen', pause:'Pausieren', last:'Letzte Nachricht', message:'Ich glaube, ich habe dir das Wichtigste noch gar nicht gesagt …', cta:'Unterhaltung öffnen', label:'Marias Profil' },
    nl: { open:'Profiel openen', close:'Profiel sluiten', online:'Nu online', about:'Over mij', voice:'Spraakbericht', play:'Afspelen', pause:'Pauzeren', last:'Laatste bericht', message:'Volgens mij heb ik je het belangrijkste nog niet verteld…', cta:'Gesprek openen', label:'Maria’s profiel' },
    fr: { open:'Ouvrir le profil', close:'Fermer le profil', online:'En ligne maintenant', about:'À propos de moi', voice:'Message vocal', play:'Écouter', pause:'Pause', last:'Dernier message', message:'Je crois que je ne t’ai pas encore dit le plus important…', cta:'Ouvrir la conversation', label:'Profil de Marie' },
    it: { open:'Apri il profilo', close:'Chiudi il profilo', online:'Online adesso', about:'Su di me', voice:'Messaggio vocale', play:'Riproduci', pause:'Pausa', last:'Ultimo messaggio', message:'Credo di non averti ancora detto la cosa più importante…', cta:'Apri la conversazione', label:'Profilo di Maria' },
    es: { open:'Abrir perfil', close:'Cerrar perfil', online:'En línea ahora', about:'Sobre mí', voice:'Mensaje de voz', play:'Reproducir', pause:'Pausar', last:'Último mensaje', message:'Creo que todavía no te he contado lo más importante…', cta:'Abrir conversación', label:'Perfil de María' },
    pt: { open:'Abrir perfil', close:'Fechar perfil', online:'Online agora', about:'Sobre mim', voice:'Mensagem de voz', play:'Ouvir', pause:'Pausar', last:'Última mensagem', message:'Acho que ainda não te contei o mais importante…', cta:'Abrir conversa', label:'Perfil da Maria' },
    pl: { open:'Otwórz profil', close:'Zamknij profil', online:'Teraz online', about:'O mnie', voice:'Wiadomość głosowa', play:'Odtwórz', pause:'Wstrzymaj', last:'Ostatnia wiadomość', message:'Chyba nie powiedziałam Ci jeszcze najważniejszego…', cta:'Otwórz rozmowę', label:'Profil Marii' },
    sv: { open:'Öppna profil', close:'Stäng profil', online:'Online nu', about:'Om mig', voice:'Röstmeddelande', play:'Spela', pause:'Pausa', last:'Senaste meddelandet', message:'Jag tror inte att jag har berättat det viktigaste för dig än…', cta:'Öppna konversationen', label:'Marias profil' },
    no: { open:'Åpne profil', close:'Lukk profil', online:'Pålogget nå', about:'Om meg', voice:'Talemelding', play:'Spill av', pause:'Pause', last:'Siste melding', message:'Jeg tror ikke jeg har fortalt deg det viktigste ennå…', cta:'Åpne samtalen', label:'Marias profil' },
    da: { open:'Åbn profil', close:'Luk profil', online:'Online nu', about:'Om mig', voice:'Talebesked', play:'Afspil', pause:'Pause', last:'Seneste besked', message:'Jeg tror ikke, jeg har fortalt dig det vigtigste endnu…', cta:'Åbn samtalen', label:'Marias profil' },
    fi: { open:'Avaa profiili', close:'Sulje profiili', online:'Paikalla nyt', about:'Tietoa minusta', voice:'Ääniviesti', play:'Toista', pause:'Tauko', last:'Viimeisin viesti', message:'Luulen, etten ole vielä kertonut sinulle sitä kaikkein tärkeintä…', cta:'Avaa keskustelu', label:'Marian profiili' },
    el: { open:'Άνοιγμα προφίλ', close:'Κλείσιμο προφίλ', online:'Συνδεδεμένη τώρα', about:'Σχετικά με μένα', voice:'Φωνητικό μήνυμα', play:'Αναπαραγωγή', pause:'Παύση', last:'Τελευταίο μήνυμα', message:'Νομίζω πως δεν σου έχω πει ακόμα το πιο σημαντικό…', cta:'Άνοιγμα συνομιλίας', label:'Το προφίλ της Μαρίας' },
    hr: { open:'Otvori profil', close:'Zatvori profil', online:'Sada online', about:'O meni', voice:'Glasovna poruka', play:'Reproduciraj', pause:'Pauziraj', last:'Posljednja poruka', message:'Mislim da ti još nisam rekla ono najvažnije…', cta:'Otvori razgovor', label:'Marijin profil' },
    sl: { open:'Odpri profil', close:'Zapri profil', online:'Trenutno na spletu', about:'O meni', voice:'Glasovno sporočilo', play:'Predvajaj', pause:'Premor', last:'Zadnje sporočilo', message:'Mislim, da ti še nisem povedala tistega najpomembnejšega…', cta:'Odpri pogovor', label:'Marijin profil' },
    sk: { open:'Otvoriť profil', close:'Zavrieť profil', online:'Práve online', about:'O mne', voice:'Hlasová správa', play:'Prehrať', pause:'Pozastaviť', last:'Posledná správa', message:'Myslím, že som ti ešte nepovedala to najdôležitejšie…', cta:'Otvoriť rozhovor', label:'Marijin profil' },
  ...
  const getProfile = () => {
    ...
    const title = hero?.querySelector('h2')?.textContent?.trim() || 'Maria, 41';
