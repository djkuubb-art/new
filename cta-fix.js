(() => {
  const labels = {
    'en-GB': 'Reply to Maria',
    'en-US': 'Reply to Maria',
    'en-SG': 'Reply to Maria',
    de: 'Maria antworten',
    nl: 'Maria antwoorden',
    fr: 'Répondre à Marie',
    it: 'Rispondi a Maria',
    es: 'Responder a María',
    pt: 'Responder à Maria',
    pl: 'Odpowiedz Marii',
    sv: 'Svara Maria',
    no: 'Svar Maria',
    da: 'Svar Maria',
...
(() => {
  ...
  const namesByLocale = {
    'en-GB': ['Maria', 'Claire', 'Emma', 'Laura', 'Sophie', 'Rachel', 'Julia', 'Hannah', 'Louise', 'Rebecca'],
    'en-US': ['Maria', 'Rachel', 'Megan', 'Laura', 'Jennifer', 'Amanda', 'Nicole', 'Michelle', 'Melissa', 'Rebecca'],
    'en-SG': ['Maria', 'Grace', 'Elaine', 'Joanne', 'Cheryl', 'Patricia', 'Irene', 'Linda', 'Karen', 'Susan'],
    de: ['Maria', 'Claudia', 'Katja', 'Andrea', 'Martina', 'Nicole', 'Petra', 'Sandra', 'Heike', 'Birgit'],
    nl: ['Maria', 'Monique', 'Linda', 'Marieke', 'Karin', 'Esther', 'Petra', 'Anita', 'Ilse', 'Bianca'],
    fr: ['Marie', 'Sophie', 'Élodie', 'Isabelle', 'Valérie', 'Sandrine', 'Céline', 'Caroline', 'Virginie', 'Laurence'],
    it: ['Maria', 'Laura', 'Alessandra', 'Monica', 'Silvia', 'Paola', 'Barbara', 'Elena', 'Daniela', 'Cristina'],
    es: ['María', 'Laura', 'Carmen', 'Ana', 'Isabel', 'Patricia', 'Mónica', 'Elena', 'Cristina', 'Silvia'],
    pt: ['Maria', 'Ana', 'Carla', 'Rita', 'Teresa', 'Paula', 'Sandra', 'Helena', 'Cristina', 'Susana'],
    pl: ['Maria', 'Katarzyna', 'Monika', 'Agnieszka', 'Joanna', 'Magdalena', 'Ewa', 'Beata', 'Marta', 'Dorota'],
    sv: ['Maria', 'Maria', 'Sofia', 'Karin', 'Helena', 'Linda', 'Eva', 'Malin', 'Camilla', 'Åsa'],
    no: ['Maria', 'Marianne', 'Ingrid', 'Linda', 'Kristin', 'Monica', 'Eva', 'Camilla', 'Heidi', 'Tone'],
    da: ['Maria', 'Helle', 'Louise', 'Camilla', 'Charlotte', 'Line', 'Maria', 'Anne', 'Lene', 'Rikke'],
    fi: ['Maria', 'Minna', 'Laura', 'Tiina', 'Päivi', 'Katja', 'Marika', 'Johanna', 'Hanna', 'Kirsi'],
    el: ['Μαρία', 'Ελένη', 'Κατερίνα', 'Σοφία', 'Μαρία', 'Δήμητρα', 'Ιωάννα', 'Χριστίνα', 'Γεωργία', 'Νίκη'],
    ...
    sk: ['Mária', 'Martina', 'Zuzana', 'Katarína', 'Monika', 'Petra', 'Eva', 'Lucia', 'Andrea', 'Veronika'],
    cs: ['Marie', 'Petra', 'Lucie', 'Martina', 'Monika', 'Kateřina', 'Eva', 'Lenka', 'Andrea', 'Veronika'],
    hu: ['Mária', 'Andrea', 'Éva', 'Mónika', 'Zsuzsa', 'Judit', 'Krisztina', 'Erika', 'Ágnes', 'Ildikó'],
    he: ['מריה', 'מיכל', 'יעל', 'רונית', 'אורית', 'שרון', 'מירב', 'טלי', 'סיגל', 'ליאת']
  };
